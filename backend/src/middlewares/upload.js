/**
 * Configuração do Multer para upload de banners e comprovantes.
 */
...
function makeStorage(subdir) {
  return multer.diskStorage({
    ...
    filename: (_req, file, cb) => {
      ...
      // Evita nomes como ".pdf.pdf" vindos do WhatsApp
...
function isComprovanteAceito(file) {
  ...
  // WhatsApp / alguns browsers mandam octet-stream ou MIME vazio
